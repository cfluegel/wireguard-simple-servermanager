...
- Templates required under `templates/`:
  ...
  - `templates/client`       – client base config; placeholders: `%PRIVKEY%`, `%SRVENDPOINT%`, `%SRVPUBKEY%`, `%SRVPORT%`, `%CLIENTIP%`
...
- `server.txt` (one line per server):
  - `NAME;ENDPOINT;INTERFACE;SERVER_ADDRESS/CIDR;NETWORK/CIDR;PORT;SERVER_PRIVATE_KEY`
  - Example:
    - `wg-eu;vpn.example.com;wg0;10.0.0.1/24;10.0.0.0/24;51820;SERVER_PRIVATE_KEY_BASE64`

- `clients.txt` (one line per client):
  - `CLIENT_IP/CIDR;CLIENT_NAME;CLIENT_PRIVATE_KEY;OPTIONAL_NETWORKS`
  ...
  - Examples:
    - `10.0.0.2/32;alice;CLIENT_PRIVATE_KEY_BASE64;192.168.0.0/16`
    - `10.0.0.3/32;bob;CLIENT_PRIVATE_KEY_BASE64;`
